...
code const u8 pa_tab9[]={0x35};
code const u8 pa_tab10[]={0x11};
code const u8 pa_tab11[]={0x29};
...
void W_write()
{
	...
	W_COM(0x01,0x00);
	W_COM(0x02,0x00);
	W_COM(0x03,0x57);      //STVA=STV1~4
	W_COM(0x04,0xD3);       //STVB=STV0 
	W_COM(0x05,0x00);        
	W_COM(0x06,0x11);       //STVA_Rise
	...
	W_COM(0x0e,0x00);        
	W_COM(0x0f,0x3F);       //CLW1(ALR) Duty=45%
	W_COM(0x10,0x3F);       //CLW2(ARR) Duty=45%
	W_COM(0x11,0x00);           
	W_COM(0x12,0x00);       
	W_COM(0x13,0x00);        
	W_COM(0x14,0x00);
	...
	W_COM(0x2a,0x00);  
	W_COM(0x2b,0x00);
	W_COM(0x2c,0x00);       //GCH R
	W_COM(0x2d,0x00);       //GCL R 
	W_COM(0x2e,0x00);       //GCH F        
	W_COM(0x2f,0x00);       //GCL F       
	W_COM(0x30,0x00);
	W_COM(0x31,0x00);
	...
	W_COM(0x6b,0x02);
	W_COM(0x6c,0x02);
	W_COM(0x6d,0x02);       //CLKA 40?郯胜? C0も笆は(X8把σCLKB)
	W_COM(0x6e,0x02);       //C0
	W_COM(0x6f,0x02);       //CLKA_Rise
	W_COM(0x70,0x14);       //CLKA_Fall
	W_COM(0x71,0x15);        
	W_COM(0x72,0x06);        
	W_COM(0x73,0x02);        
	W_COM(0x74,0x02);
...
//	ssd2828_regconfig(0xba,0xc03f);	//TPS02
	ssd2828_regconfig(0xba,0x8015);	//0X804B
